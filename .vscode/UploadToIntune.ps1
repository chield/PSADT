...
Connect-MSIntuneGraph -TenantID "interstellar.nl" -Verbose
    ...
    $AppIconFile = "C:\Stuff\PrintIX-logo.png"
    $Appversion = "1.00"

    # TODO Create custom display name like 'Name' and 'Version'
    $DisplayName = "Printix Client"
