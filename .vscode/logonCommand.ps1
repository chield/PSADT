...
$Application = "hpeproductbulletin"
...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\$Application\Deploy-Application.exe" -ArgumentList "Uninstall" -Wait
