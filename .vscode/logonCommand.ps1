...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\devops\Deploy-Application.exe" -Wait
...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\devops\Deploy-Application.exe" -ArgumentList "Uninstall" -Wait
