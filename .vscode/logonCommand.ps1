...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\7-Zip\Deploy-Application.exe" -Wait
...
Start-Process -FilePath "C:\Users\WDAGUtilityAccount\Desktop\7-Zip\Deploy-Application.exe" -ArgumentList "Uninstall" -Wait
